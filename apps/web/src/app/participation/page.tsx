  ...
  return (
    <section className="relative px-6 py-20 sm:py-28 overflow-hidden">
      ...
      <WatermarkCard className="mx-auto max-w-2xl text-center">
        ...
        <p className="font-sans text-[15px] leading-relaxed text-vert-profond/85 mt-6">
          Une alliance ne se construit jamais seule. Aujourd&apos;hui, nous souhaitons vous
          donner la possibilité de prendre part à cette nouvelle saison.
        </p>
